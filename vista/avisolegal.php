...
<body>
    <div class="container mt-5">
        <h1 class="text-center">AVISO LEGAL Y CONDICIONES GENERALES DE USO</h1>
        ...
        <section>
            ...
            <p>
                La titularidad de este sitio web, <a href="http://20.19.37.89//index.php" target="_blank">Estudiofit</a>, 
                (en adelante, Sitio Web) la ostenta: Alejandro Law Roca, con NIF: [NIF], y cuyos datos de contacto son:
            </p>
            <p>
                Dirección: Calle San Pablo, Nº 4, Torrevieja, Alicante<br>
                Teléfono de contacto: [Teléfono]<br>
        ...
        <section>
            ...
            <p>
                Gimnasio EstudioFit se reserva la facultad de modificar, en cualquier momento, y sin aviso previo, la
                presentación y configuración del Sitio Web y de los Contenidos y Servicios que en él pudieran estar
                incorporados. El Usuario reconoce y acepta que en cualquier momento Gimnasio EstudioFit pueda
            ...
            <p>
                ...
                los Usuarios, y el Usuario y Gimnasio EstudioFit, como los comentarios y/o espacios de blogging, confiere
                ...
                de la correspondiente normativa legal de obligado cumplimiento según el caso. Dada la relevancia de lo
                anterior, se recomienda al Usuario leerlas cada vez que visite el Sitio Web.
            </p>
            <p>
                El Sitio Web de Gimnasio EstudioFit proporciona gran diversidad de información, servicios y datos. El
                Usuario asume su responsabilidad para realizar un uso correcto del Sitio Web. Esta responsabilidad se
                extenderá a:
            </p>
            <ul>
                <li>Un uso de la información, Contenidos y/o Servicios y datos ofrecidos por Gimnasio EstudioFit sin que
                    sea contrario a lo dispuesto por las presentes Condiciones, la Ley, la moral o el orden público, o
                    que de cualquier otro modo puedan suponer lesión de los derechos de terceros o del mismo
                    funcionamiento del Sitio Web.
                </li>
                <li>La veracidad y licitud de las informaciones aportadas por el Usuario en los formularios extendidos
                    por Gimnasio EstudioFit para el acceso a ciertos Contenidos o Servicios ofrecidos por el Sitio Web. En
                    todo caso, el Usuario notificará de forma inmediata a Gimnasio EstudioFit acerca de cualquier hecho
                    que permita el uso indebido de la información registrada en dichos formularios, tales como, pero no
                    sólo, el robo, extravío, o el acceso no autorizado a identificadores y/o contraseñas, con el fin de
                    proceder a su inmediata cancelación.
                </li>
            </ul>
            <p>
                Gimnasio EstudioFit se reserva el derecho de retirar todos aquellos comentarios y aportaciones que
            ...
            <p>
                En cualquier caso, Gimnasio EstudioFit no será responsable de las opiniones vertidas por los Usuarios a
            ...
            <p>
                ...
                Gimnasio EstudioFit y el Usuario.
            </p>
            <p>
                El Usuario declara ser mayor de edad y disponer de la capacidad jurídica suficiente para vincularse por
                las presentes Condiciones. Por lo tanto, este Sitio Web de Gimnasio EstudioFit no se dirige a menores de
                edad. Gimnasio EstudioFit declina cualquier responsabilidad por el incumplimiento de este requisito.
            </p>
            <p>
                El Sitio Web está dirigido principalmente a Usuarios residentes en España. Gimnasio EstudioFit no asegura
                que el Sitio Web cumpla con legislaciones de otros países, ya sea total o parcialmente. Si el Usuario
                reside o tiene su domiciliado en otro lugar y decide acceder y/o navegar en el Sitio Web lo hará bajo su
                propia responsabilidad, deberá asegurarse de que tal acceso y navegación cumple con la legislación local
                que le es aplicable, no asumiendo Gimnasio EstudioFit responsabilidad alguna que se pueda derivar de dicho
                acceso.
            </p>
        </section>
        ...
        <section>
            ...
            <p>
                Gimnasio EstudioFit no garantiza la continuidad, disponibilidad y utilidad del Sitio Web, ni de los
                Contenidos o Servicios. Gimnasio EstudioFit hará todo lo posible por el buen funcionamiento del Sitio
                Web, sin embargo, no se responsabiliza ni garantiza que el acceso a este Sitio Web no vaya a ser
            ...
            <p>
                ...
                En ningún caso Gimnasio EstudioFit será responsable por las pérdidas, daños o perjuicios de cualquier
            ...
            <p>
                Gimnasio EstudioFit tampoco se hace responsable de los daños que pudiesen ocasionarse a los usuarios por
        ...
        <section>
            ...
            <p>
                Se informa que el Sitio Web de Gimnasio EstudioFit pone o puede poner a disposición de los Usuarios medios
            ...
            <p>
                Gimnasio EstudioFit no ofrece ni comercializa por sí ni por medio de terceros los productos y/o servicios
            ...
            <p>
                Gimnasio EstudioFit en ningún caso revisará o controlará el contenido de otros sitios web, así como
            ...
            <p>
                Gimnasio EstudioFit no asume ninguna responsabilidad por los daños y perjuicios que pudieran producirse
                por el acceso, uso, calidad o licitud de los contenidos, comunicaciones, opiniones, productos y servicios
                de los sitios web no gestionados por Gimnasio EstudioFit y que sean enlazados en este Sitio Web.
            </p>
            <p>
                El Usuario o tercero que realice un hipervínculo desde una página web de otro, distinto, sitio web al
                Sitio Web de Gimnasio EstudioFit deberá saber que:
            </p>
            <ul>
                <li>No se permite la reproducción —total o parcialmente— de ninguno de los Contenidos y/o Servicios del
                    Sitio Web sin autorización expresa de Gimnasio EstudioFit.
                </li>
                <li>No se permite tampoco ninguna manifestación falsa, inexacta o incorrecta sobre el Sitio Web de
                    Gimnasio EstudioFit, ni sobre los Contenidos y/o Servicios del mismo.
                </li>
                <li>A excepción del hipervínculo, el sitio web en el que se establezca dicho hiperenlace no contendrá
                    ningún elemento, de este Sitio Web, protegido como propiedad intelectual por el ordenamiento jurídico
                    español, salvo autorización expresa de Gimnasio EstudioFit.
                </li>
                <li>El establecimiento del hipervínculo no implicará la existencia de relaciones entre Gimnasio EstudioFit
                    y el titular del sitio web desde el cual se realice, ni el conocimiento y aceptación de Gimnasio
                    EstudioFit de los contenidos, servicios y/o actividades ofrecidos en dicho sitio web, y viceversa.
                </li>
            </ul>
        </section>
        ...
        <section>
            ...
            <p>
                Gimnasio EstudioFit por sí o como parte cesionaria, es titular de todos los derechos de propiedad
            ...
            <p>
                ...
                comerciales, en cualquier soporte y por cualquier medio técnico, sin la autorización de Gimnasio
                EstudioFit.
            </p>
            <p>
                El Usuario se compromete a respetar los derechos de propiedad intelectual e industrial de Gimnasio
                EstudioFit. Podrá visualizar los elementos del Sitio Web o incluso imprimirlos, copiarlos y almacenarlos
                en el disco duro de su ordenador o en cualquier otro soporte físico siempre y cuando sea, exclusivamente,
                para su uso personal. El Usuario, sin embargo, no podrá suprimir, alterar, o manipular cualquier dispositivo
            ...
            <p>
                ...
                Gimnasio EstudioFit a través de los datos de contacto del apartado de INFORMACIÓN GENERAL de este Aviso
        ...
        <section>
            ...
            <p>
                Gimnasio EstudioFit se reserva la facultad de presentar las acciones civiles o penales que considere
                necesarias por la utilización indebida del Sitio Web y Contenidos, o por el incumplimiento de las
                presentes Condiciones.
            </p>
            <p>
                La relación entre el Usuario y Gimnasio EstudioFit se regirá por la normativa vigente y de aplicación en
